...
export const MOCK_POSTS: Post[] = [
  // EVENTS
  {
    id: '1',
    userId: 'u1',
    user: { id: 'u1', name: 'Sarah Chen', avatar: 'https://picsum.photos/200/200?random=1', isVerified: true, rating: 4.9 },
  ...
  },
  {
    id: '11',
    userId: 'u11',
    user: { id: 'u11', name: 'Neo', avatar: 'https://picsum.photos/200/200?random=11', isVerified: false, rating: 5.0 },
  ...
  },
  {
    id: '8',
    userId: 'u8',
    user: { id: 'u8', name: 'The Dealer', avatar: 'https://picsum.photos/200/200?random=8', isVerified: true, rating: 5.0 },
    category: Category.SOCIAL,
  ...
  },
  {
    id: '2',
    userId: 'u2',
    user: { id: 'u2', name: 'Mike Ross', avatar: 'https://picsum.photos/200/200?random=2', isVerified: true, rating: 4.7 },
  ...
  // TASKS (Service, Education, Rental, Companion)
  {
    id: '3',
    userId: 'u3',
    user: { id: 'u3', name: 'Emily Blunt', avatar: 'https://picsum.photos/200/200?random=3', isVerified: false, rating: 4.5 },
  ...
  },
  {
    id: '20',
    userId: 'u20',
    user: { id: 'u20', name: 'Prof. X', avatar: 'https://picsum.photos/200/200?random=20', isVerified: true, rating: 5.0 },
  ...
  },
  {
    id: '21',
    userId: 'u21',
    user: { id: 'u21', name: 'Host Master', avatar: 'https://picsum.photos/200/200?random=21', isVerified: true, rating: 4.6 },
  ...
  },
  {
    id: '22',
    userId: 'u22',
    user: { id: 'u22', name: 'Lonely Boy', avatar: 'https://picsum.photos/200/200?random=22', isVerified: false, rating: 4.0 },
  ...
  // CHALLENGES
  {
    id: '5',
    userId: 'u5',
    user: { id: 'u5', name: 'Jake Paul', avatar: 'https://picsum.photos/200/200?random=5', isVerified: true, rating: 4.2 },
  ...
  },
  {
    id: '7',
    userId: 'u7',
    user: { id: 'u7', name: 'Fit Beast', avatar: 'https://picsum.photos/200/200?random=7', isVerified: true, rating: 5.0 },
    category: Category.CHALLENGE,
  ...
  // SECRET
  {
    id: '6',
    userId: 'u6',
    user: { id: 'u6', name: 'Anonymous', avatar: '', isVerified: false, rating: 0 },
  ...
  },
  {
    id: '9',
    userId: 'u9',
    user: { id: 'u9', name: 'Anonymous', avatar: '', isVerified: false, rating: 0 },
    category: Category.ANONYMOUS,
...
export const MOCK_CHATS: ChatSession[] = [
  {
    id: 'c1',
    participant: { id: 'u5', name: 'Jessica V.', avatar: 'https://picsum.photos/200/200?random=5', isVerified: true, rating: 4.9 },
  ...
  {
    id: 'c2',
    participant: { id: 'u1', name: 'Sarah Chen', avatar: 'https://picsum.photos/200/200?random=1', isVerified: true, rating: 4.9 },
